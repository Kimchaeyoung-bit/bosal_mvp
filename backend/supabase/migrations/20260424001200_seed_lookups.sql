-- =====================================================================
-- 12_seed_lookups : seed lookup-table values
--   Idempotent (on conflict do nothing) so this can run on any env.
--   Mirrors supabase/seed.sql so `supabase db reset` and `supabase db push`
--   both produce the same lookup set.
-- =====================================================================
